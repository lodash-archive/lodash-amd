 ...
 */
define(['./baseCreate', './composeArgs', './composeArgsRight', '../objects/isObject', './setData', '../arrays/slice'], function(baseCreate, composeArgs, composeArgsRight, isObject, setData, slice) {
