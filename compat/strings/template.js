 ...
 */
define(['../objects/assign', '../utilities/escape', '../objects/keys', '../internals/reInterpolate', '../utilities/templateSettings', '../objects/values'], function(assign, escape, keys, reInterpolate, templateSettings, values) {
